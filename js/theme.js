(function ($) {
  ...
  if ($(".contact-form-vaidated").length) {
    $(".contact-form-vaidated").validate({
  ...
  if ($(".testimonials-two__slide").length) {
    $(".testimonials-two__slide").vegas({
      slides: [
        { src: "images/background/testi-bg-2-1.jpg" },
        { src: "images/background/testi-bg-2-2.jpg" },
        { src: "images/background/testi-bg-2-3.jpg" },
      ],
    });
  }
  $(window).on("load", function () {
    ...
    if ($(".testimonials-one__carousel").length) {
      if (
        $(".testimonials-one__carousel").data("carousel-margin") !== undefined
      ) {
        var testicarouselMargin = $(".testimonials-one__carousel").data(
          "carousel-margin"
        );
      } else {
